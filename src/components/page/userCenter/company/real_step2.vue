    ...
    <section class="contain comReal">
        ...
        <alertModel :type="2" title="确认提交" class="sureSubmitBox" v-show="sureSubmitState" @cancelHandle="sureSubmitState = false" @sureHandle="addLegalHandle">
            <div slot="alert-content">
                ...
                <p class="sweet">是否确认提交的所有资料无误并提交{{Config.Title}}审核？</p>
            </div>
        </alertModel>
        <!-- 认证协议弹窗 -->
        <div class="protocolCover" v-show="protocolState">
            <div class="protocol">
                ...
                <h3>{{Config.Title}}用户实名认证告知书</h3>
                <p class="pt50">本网站由数安时代科技股份有限公司、广东信鉴信息科技有限公司（下称＂{{Config.Title}}＂或“本网站”）负责运营。本用户实名认证告知书具有合同效力，适用于您在本网站的全部活动。请您在实名认证前务必仔细阅读告知书，若您不同意告知书的任意内容，或者无法准确理解{{Config.Title}}对条款的解释，请不要进行后续操作；若您进行实名认证，则表示您对告知书的全部内容已充分阅读并认可和同意遵守。同时，承诺遵守中国法律、法规、规章及其他政府规范性文件的规定，如有违反而造成任何法律后果，您将以本人名义独立承担所有相应的法律责任。</p>
                ...
                <p>3 、用户同意并授权{{Config.Title}}审核、核对用户资料信息。{{Config.Title}}将认真、全面审核用户提交的资料以确认用户真实身份，确保后续服务的合法性、有效性。所提交的用户认证信息将用于核发其专属的电子签名文件，我们将对用户的信息严格保密。</p>
                <p>4 、{{Config.Title}}的用户包括企业用户和个人用户。企业用户是指通过本网站完成全部注册程序后，使用{{Config.Title}}提供的服务，并且依据中华人民共和国法律在境内（香港、台湾、澳门除外）设立的，能够独立承担民事责任的法人和其他组织。个人用户是指中华人民共和国境内（香港、台湾、澳门除外）的公民，通过本网站完成全部注册程序后，使用{{Config.Title}}提供的服务，并且符合中华人民共和国法律规定的具有完全民事行 为能力，能够独立承担民事责任的自然人。</p>
