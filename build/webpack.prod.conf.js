...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    filename: utils.assetsPath('js/[name].gdca_zyq.min.js?a='),
    // chunkFilename: utils.assetsPath('js/[id].[chunkhash].js')
    chunkFilename: utils.assetsPath('js/[name].gdca_zyq.min.js')
  ...
  plugins: [
    ...
    /*new HtmlWebpackPlugin({
      filename: path.resolve(__dirname, '../dist/sign.html'),
      template: 'sign.html',  
      inject: true,  
      minify: {  
        removeComments: true,  
